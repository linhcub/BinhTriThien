...
namespace BinhTriThienQuanLyNhanSu
{
    public partial class QuanLyNhanVienForm : Form
    {
        ...
        private void BindingToGridView()
        {
            ...
            cbLoaiTaiKhoan.DataBindings.Clear();
            cbBacXepHang.DataBindings.Clear();

            txbMaNhanVien.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "MaNhanVien"));
            txbMatKhau.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "MatKhau"));
            txbHo.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "Ho"));
            txbTen.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "Ten"));
            txbDiaChi.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "DiaChi"));
            txbEmail.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "Email"));
            txbDienThoaiDiDong.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "DienThoaiDiDong"));
            txbDienThoaiCoDinh.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "DienThoaiCoDinh"));
            cbLoaiTaiKhoan.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "LoaiTaiKhoan"));
            cbBacXepHang.DataBindings.Add(new Binding("Text", dtgvNhanVien.DataSource, "BacXepHang"));
        ...
        //    txbDienThoaiDiDong.ReadOnly = true;
        //    txbDienThoaiCoDinh.ReadOnly = true;
        //    txbEmail.ReadOnly = true;
        //    txbDiaChi.ReadOnly = true;
        //    // FIXME cbLoaiTaiKhoan...
        //    // FIXME cbBacXepHang...
        ...
        //    txbHo.ReadOnly = false;
        //    txbTen.ReadOnly = false;
        //    txbDienThoaiDiDong.ReadOnly = false;
        //    txbDienThoaiCoDinh.ReadOnly = false;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            NhanVien nhanVien = context.NhanVien.FirstOrDefault(nv => nv.MaNhanVien == txbMaNhanVien.Text);
            if (nhanVien != null)
            {
                // sửa
