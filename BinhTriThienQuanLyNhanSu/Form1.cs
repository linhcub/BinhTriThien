    ...
    public partial class Form1 : Form
    {
        ...
        private void View()
        {
            var nhanViens = context.NhanVien.Select(nhanVien => new
            {
                ...
                TaiKhoan = nhanVien.LoaiTaiKhoan.Ten,
        ...
        private void Edit()
        {
            string maNhanVien = nhanVienGrid.SelectedCells[0].OwningRow.Cells["MaNhanVien"].Value.ToString();
            NhanVien nhanVien = context.NhanVien.First(nv => nv.MaNhanVien == maNhanVien);
            var taiKhoanAdmin = context.LoaiTaiKhoan.First(taikhoan => taikhoan.MaLoaiTaiKhoan == "TK01");
            var bac1 = context.BacXepHang.First(bacxephang => bacxephang.MaBacXepHang == "Bac01");
